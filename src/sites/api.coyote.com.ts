...
export class ApiCoyoteCom extends SearchSite {
    public static siteName = 'Coyote'
    private loginPage = 'https://api.coyote.com/Account/Login';
    private searchPage = 'https://connect.coyote.com/available-loads-v3';
    ...
    public async login(task: ITASK) {
        try {
            ...
            console.log('coyote begin prepare', task.password);
